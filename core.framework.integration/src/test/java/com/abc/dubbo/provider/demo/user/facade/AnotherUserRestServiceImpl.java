 ...
 */
package com.abc.dubbo.provider.demo.user.facade;

import com.abc.dubbo.demo.api.user.facade.AnotherUserRestService;
import com.abc.dubbo.demo.api.user.facade.RegistrationResult;
