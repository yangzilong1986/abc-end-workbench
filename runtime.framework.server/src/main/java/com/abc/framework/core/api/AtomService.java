 ...
 */
public interface AtomService<D extends MyBatisDao<T>,T extends Identifiable> {
	//D extends BaseDao<T, String>, T
	/**
	...
	/**
	 * 查询对象列表
	 * @param query 查询参数，如果未null则查询所有，相当于调用方法{@link com.ndlan.framework.core.dao.MyBatisDao.selectAll }
	 * @return 结果对象列表
	 */
