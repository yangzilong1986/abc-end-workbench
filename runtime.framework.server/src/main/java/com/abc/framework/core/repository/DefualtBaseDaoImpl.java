package com.abc.framework.core.repository;
...
import com.abc.framework.core.constants.SqlId;
import com.abc.framework.core.exception.RepositoryException;
import com.abc.framework.core.utils.BeanUtils;
import com.abc.framework.core.utils.UUIDUtils;
...
public abstract class DefualtBaseDaoImpl<T extends Identifiable> implements MyBatisDao<T> {
	...
	protected Map<String, Object> getParams(T query, Pageable pageable) {
		...
		if(query.getConditionLike()!=null){
			params.put("liking", query.getConditionLike().decodeConditionLike());
		}
		if(query.getConditionOr()!=null){
			params.put("oring", query.getConditionOr().decodeConditionOr());
		}
		return params;
	}
