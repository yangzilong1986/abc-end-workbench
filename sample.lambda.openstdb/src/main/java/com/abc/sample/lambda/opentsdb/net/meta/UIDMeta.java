...
public final class UIDMeta {
   ...
   */
  public UIDMeta(final UniqueId.UniqueIdType type, final String uid) {
    this.type = type;
    this.uid = uid;
    initializeChangedMap();
  }
   ...
   */
  public UIDMeta(final UniqueId.UniqueIdType type, final byte[] uid, final String name) {
    this.type = type;
  ...
  public static Deferred<UIDMeta> getUIDMeta(final TSDB tsdb,
                                             final UniqueId.UniqueIdType type, final String uid) {
   ...
   */
  public static Deferred<UIDMeta> getUIDMeta(final TSDB tsdb,
                                             final UniqueId.UniqueIdType type, final byte[] uid) {
