...
import com.abc.sample.lambda.opentsdb.net.core.FillPolicy;
import com.abc.sample.lambda.opentsdb.net.core.IncomingDataPoint;
...
import com.abc.sample.lambda.opentsdb.net.stats.QueryStats.QueryStat;
import com.abc.sample.lambda.opentsdb.net.tree.Branch;
import com.abc.sample.lambda.opentsdb.net.tree.Tree;
import com.abc.sample.lambda.opentsdb.net.tree.TreeRule;
...
class HttpJsonSerializer extends HttpSerializer {
  ...
  public ChannelBuffer formatAnnotationBulkDeleteV1(
      final AnnotationRpc.AnnotationBulkDelete request) {
