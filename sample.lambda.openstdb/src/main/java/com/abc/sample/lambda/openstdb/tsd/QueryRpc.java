...
import com.abc.sample.lambda.opentsdb.net.core.*;
...
import com.abc.sample.lambda.opentsdb.net.meta.TSUIDQuery;
import com.abc.sample.lambda.opentsdb.net.query.expression.ExpressionTree;
...
final class QueryRpc implements HttpRpc {
  ...
  private void handleExpressionQuery(final TSDB tsdb, final HttpQuery query) {
    final Query v2_query =
        JSON.parseToObject(query.getContent(), Query.class);
    //v2_query.validate();
