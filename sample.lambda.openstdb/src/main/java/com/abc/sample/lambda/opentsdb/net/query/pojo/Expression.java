...
package com.abc.sample.lambda.opentsdb.net.query.pojo;

import com.abc.sample.lambda.opentsdb.net.query.expression.NumericFillPolicy;
import com.abc.sample.lambda.opentsdb.net.query.expression.VariableIterator;
...
public class Expression extends Validatable {
  ...
  public void validate() {
    ...
    // others are optional
    if (join == null) {
      join = Join.Builder().setOperator(VariableIterator.SetOperator.UNION).build();
    }
  }
