...
import com.abc.sample.lambda.opentsdb.net.core.DataPoint;
import com.abc.sample.lambda.opentsdb.net.core.DataPoints;
import com.abc.sample.lambda.opentsdb.net.core.QueryException;
import com.abc.sample.lambda.opentsdb.net.core.TSDB;
import com.abc.sample.lambda.opentsdb.net.core.TSQuery;
import com.abc.sample.lambda.opentsdb.net.core.TSSubQuery;
import com.abc.sample.lambda.opentsdb.net.core.Tags;
import com.abc.sample.lambda.opentsdb.net.query.expression.ExpressionDataPoint;
import com.abc.sample.lambda.opentsdb.net.query.expression.ExpressionIterator;
import com.abc.sample.lambda.opentsdb.net.query.expression.NumericFillPolicy;
import com.abc.sample.lambda.opentsdb.net.query.expression.TimeSyncedIterator;
import com.abc.sample.lambda.opentsdb.net.query.expression.VariableIterator.SetOperator;
import com.abc.sample.lambda.opentsdb.net.query.filter.TagVFilter;
import com.abc.sample.lambda.opentsdb.net.query.pojo.Expression;
import com.abc.sample.lambda.opentsdb.net.query.pojo.Filter;
import com.abc.sample.lambda.opentsdb.net.query.pojo.Metric;
import com.abc.sample.lambda.opentsdb.net.query.pojo.Output;
import com.abc.sample.lambda.opentsdb.net.query.pojo.Query;
import com.abc.sample.lambda.opentsdb.net.query.pojo.Timespan;
...
import com.abc.sample.lambda.opentsdb.net.utils.JSON;
...
public class QueryExecutor {
  ...
  public void execute(final HttpQuery query) {
     ...
     */
    class BuildCB implements Callback<Deferred<Object>, com.abc.sample.lambda.opentsdb.net.core.Query[]> {
      @Override
      public Deferred<Object> call(final com.abc.sample.lambda.opentsdb.net.core.Query[] queries) {
        final ArrayList<Deferred<DataPoints[]>> deferreds = 
            new ArrayList<Deferred<DataPoints[]>>(queries.length);
        
        for (final com.abc.sample.lambda.opentsdb.net.core.Query query : queries) {
