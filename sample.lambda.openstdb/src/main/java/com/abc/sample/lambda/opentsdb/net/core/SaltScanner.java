...
public class SaltScanner {
  ...
  private void mergeAndReturnResults() {
    ...
    if (query_stats != null) {
      query_stats.addStat(query_index, QueryStats.QueryStat.SCANNER_MERGE_TIME,
  ...
  final class ScannerCB implements Callback<Object, 
    ...
    */
    ...
    void close(final boolean ok) {
      ...
      if (query_stats != null) {
        query_stats.addScannerStat(query_index, index, QueryStats.QueryStat.SCANNER_TIME,
        ...
        query_stats.addScannerStat(query_index, index, 
            QueryStats.QueryStat.HBASE_TIME, fetch_time);
        query_stats.addScannerStat(query_index, index, 
            QueryStats.QueryStat.SUCCESSFUL_SCAN, ok ? 1 : 0);
        
        // Post Scan stats
        query_stats.addScannerStat(query_index, index, 
            QueryStats.QueryStat.ROWS_PRE_FILTER, rows_pre_filter);
        query_stats.addScannerStat(query_index, index,
            QueryStats.QueryStat.DPS_PRE_FILTER, dps_pre_filter);
        query_stats.addScannerStat(query_index, index, 
            QueryStats.QueryStat.ROWS_POST_FILTER, rows_post_filter);
        query_stats.addScannerStat(query_index, index,
            QueryStats.QueryStat.DPS_POST_FILTER, dps_post_filter);
        query_stats.addScannerStat(query_index, index, 
            QueryStats.QueryStat.SCANNER_UID_TO_STRING_TIME, uid_resolve_time);
        query_stats.addScannerStat(query_index, index, 
            QueryStats.QueryStat.UID_PAIRS_RESOLVED, uids_resolved);
        query_stats.addScannerStat(query_index, index, 
            QueryStats.QueryStat.COMPACTION_TIME, compaction_time);
      }
