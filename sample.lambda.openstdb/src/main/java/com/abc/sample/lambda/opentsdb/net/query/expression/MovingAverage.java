...
import com.abc.sample.lambda.opentsdb.net.core.IllegalDataException;
...
public class MovingAverage implements Expression {
  ...
  static final class MovingAverageAggregator extends Aggregator {
     ...
     * the # of data points
     */
    public MovingAverageAggregator(final Aggregators.Interpolation method, final String name,
