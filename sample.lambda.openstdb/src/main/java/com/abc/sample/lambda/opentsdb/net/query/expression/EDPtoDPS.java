...
import com.abc.sample.lambda.opentsdb.net.utils.ByteSet;
...
public class EDPtoDPS implements DataPoints {
  ...
  public Deferred<String> metricNameAsync() {
    ...
    return tsdb.getUidName(UniqueId.UniqueIdType.METRIC, uid);
  }
  ...
  public Deferred<List<String>> getAggregatedTagsAsync() {
    ...
    for (final byte[] tagk : tagks) {
      names.add(tsdb.getUidName(UniqueId.UniqueIdType.TAGK, tagk));
    }
