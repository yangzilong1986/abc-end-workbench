...
import java.util.*;
	...
	{
		static String PATH_NAME="D:/DevN/sample-data/algs4-data/bplustree";
		static String tempdirectory = PATH_NAME; // set to a directory to test storing to/from files
		...
		static boolean DoAllTests = false;
		...
		public static java.io.RandomAccessFile makeFile(String name) throws Exception
		{
			if (tempdirectory==null) 
			{
				System.out.println("to run these tests you need to edit " +
						"the source file, adding a String definition for tempdirectory");
				throw new Exception("to run these tests you need to edit the source file, " +
						"adding a String definition for tempdirectory");
			}
