 ...
 * ------------------------ */
   ...
   */
   ...
   public Matrix (double vals[], int m) {// row,//m 行
      this.m = m;
 ...
 * ------------------------ */
   ...
   */
   ...
   /** LU Decomposition
    * 在线性代数中， LU分解(LU Decomposition)是矩阵分解的一种，可以将一个矩阵分解为一个单位下三角矩阵和一个上三角矩阵的乘积
   ...
   */
   ...
   /** QR Decomposition
    * QR（正交三角）分解法是目前求一般矩阵全部特征值的最有效并广泛应用的方法，一般矩阵先经过正交相似变化成为Hessenberg矩阵，
    * 然后再应用QR方法求特征值和特征向量。它是将矩阵分解成一个正规正交矩阵Q与上三角形矩阵R，所以称为QR分解法，与此正规正交矩阵的通用符号Q有关。
 ...
 * ------------------------ */
  ...
  private static final long serialVersionUID = 1;
   ...
   public Matrix (double[] vals, Axis axis, int s) {
      switch (axis){
         case row:
            this.m = s;
            this.n=vals.length;
   ...
   public Matrix( double[] vals ,Axis axis, Shape shapeCopy){
