...
public class KMeansClustering {
  //D:\DevN\abc-end-workbench\core.framework.datamining\target\test-classes\reuters\reuters-vectors\tfidf-vectors
  public static final String OUT_DIR="core.framework.datamining/target/test-classes/";
  public static void main(String args[]) throws Exception {
    
    String inputDir =OUT_DIR+ "reuters/reuters-vectors/";//reuters
    int k = 25;
