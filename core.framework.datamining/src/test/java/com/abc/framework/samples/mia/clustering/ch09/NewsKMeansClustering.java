...
public class NewsKMeansClustering {
  ...
  public static void main(String args[]) throws Exception {
    ...
    String inputDir = OUT_DIR+"reuters-seqfiles";
    ...
    String outputDir =OUT_DIR+ "/newsClusters";
    ...
    SequenceFile.Reader reader = new SequenceFile.Reader(fs,
        new Path("D:\\DevN\\abc-end-workbench\\core.framework.datamining\\" +
                "target\\test-classes\\reuters\\newsClusters\\clusters\\" +
                "core.framework.datamining\\target\\test-classes\\clusteredPoints\\part-m-00000"), conf);
