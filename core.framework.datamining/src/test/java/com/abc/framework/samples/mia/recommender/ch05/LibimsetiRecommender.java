...
public class LibimsetiRecommender implements Recommender {
    ...
    private final static String file = "D:/DevN/sample-data/dadamining/libimseti/ratings.dat";
    private final static String gender = "D:/DevN/sample-data/dadamining/libimseti/gender.dat";

    public LibimsetiRecommender() throws TasteException, IOException {

        this(new FileDataModel(readResourceToTempFile(file)));
    }
    ...
    public LibimsetiRecommender(DataModel model)
        ...
        this.model = model;
        FastIDSet[] menWomen = GenderRescorer.parseMenWomen(readResourceToTempFile(gender));
        men = menWomen[0];
        women = menWomen[1];
    ...
    static File readResourceToTempFile(String resourceName) throws IOException {
        ...
        return tempFile;
//    return  File.createTempFile("taste", null);
    }
