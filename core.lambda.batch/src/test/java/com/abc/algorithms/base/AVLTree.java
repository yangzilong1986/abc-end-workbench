...
/**
 * (1) LL：LeftLeft，也称为"左左"。插入或删除一个节点后，
 * 根节点的左子树的左子树还有非空子节点，导致"根的左子树的高度"比"根的右子树的高度"大2，导致AVL树失去了平衡。
 例如，在上面LL情况中，由于"根节点(8)的左子树(4)的左子树(2)还有非空子节点"，而"根节点(8)的右子树(12)没有子节点"；
 导致"根节点(8)的左子树(4)高度"比"根节点(8)的右子树(12)"高2。
...
public class AVLTree<T extends Comparable<T>> {
    ...
    // AVL树的节点(内部类)
    class AVLTreeNode<T extends Comparable<T>>  implements Iterable<T>{
        T key;                // 关键字(键值)
        int height;         // 高度
    ...
    public static void main(String[] args) {
        ...
        System.out.print("== 高度: \t"+tree.height());
        System.out.print("== 最小值: \t"+ tree.minimum());
        System.out.print("== 最大值: \t"+ tree.maximum());
